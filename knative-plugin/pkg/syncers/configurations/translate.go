...
func (k *kconfigSyncer) findParentObject(ctx *context.SyncContext, obj client.Object) (client.Object, error) {
	...
	for _, owner := range owners {
		...
		if err != nil {
			...
			klog.Infof("found owner for virtual config %s/%s => ksvc:%s/%s",
				obj.GetNamespace(),
				obj.GetName(),
				parent.GetNamespace(),
				parent.GetName(),
...
func (k *kconfigSyncer) ReverseTranslateMetadata(ctx *context.SyncContext, obj, parent client.Object) client.Object {
	pName := k.PhysicalToVirtual(obj)
